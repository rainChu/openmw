...
namespace Compiler
{
    ...
    namespace Network
    {
        ...
        const int opcodeNetworkClose = 0x2000330;
        // Client
        const int opcodeNetworkJoin = 0x2000331;
        // Server
        const int opcodeNetworkCreate = 0x2000332;
        const int opcodeNetworkKick = 0x2000333;

        // This one looks like an Ai Package, but really
        // it's part of the Network extension.
        const int opcodeAiPuppet = 0x2000334;
        const int opcodeAiPuppetExplicit = 0x2000335;
    }
